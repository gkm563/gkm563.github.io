...
export const JOURNEY_DATA = {
  ...
  milestones: [
    ...
    {
      id: "sem-5-lpai-internship-shortlist",
      title: "Shortlisted for Land Ports Authority of India (LPAI) Internship 2026",
      shortDescription: "Shortlisted for national LPAI Internship Program (Sep–Oct 2026 cohort) exploring border infrastructure, trade facilitation, and data systems.",
      fullDescription: "Selected for the prestigious Land Ports Authority of India (LPAI) Internship Program 2026 cohort under the Ministry of External Affairs / Home Affairs. Exploring the intersection of Computer Science, Data Science, and smart border management — including real-time trade logistics dashboards, automated port operations, and infrastructure-led economic development.",
      startDate: "Aug 2026",
      endDate: "Oct 2026",
      phaseId: "year-3",
      semesterId: "sem-5",
      ...
      status: "current",
      importance: "major",
      skills: ["Data Science", "Public Infrastructure", "Trade Facilitation", "Logistics Systems", "Government Policy", "Analytics"],
      organization: "Land Ports Authority of India (LPAI)",
      role: "Research & Technology Intern (Shortlisted)",
      location: "New Delhi / Remote, India",
      whatHappened: "Shortlisted for the national cohort to apply data analytics and predictive systems to land port infrastructure.",
      whyItMattered: "Direct exposure to India's national border infrastructure ecosystem, cross-border trade facilitation, and public-private partnerships.",
      whatILearned: "Border infrastructure operations, institutional coordination, PPP frameworks, and tech-driven logistics optimization.",
      impact: "Contributing technological perspectives to national infrastructure challenges.",
      evidence: {
        images: [],
    ...
    {
      id: "sem-5-sih-2026-lead-organizer",
      title: "Lead Organizer — Smart India Hackathon (SIH) 2026 Internal Hackathon",
      shortDescription: "Spearheaded SIH 2026 College-Level Internal Hackathon managing 76 teams, 500+ participants, and 8-member evaluation panels.",
      fullDescription: "Led the 15-day end-to-end planning, registration verification, problem statement allocation, and on-ground execution of the SIH 2026 Internal Hackathon at United Institute of Technology (UIT), Prayagraj. Coordinated with Principal Prof. Sanjay Srivastava, Dean Students' Welfare Dr. Manas Pandey, and SPOC Dr. Dhananjay Sharma.",
      startDate: "Aug 2026",
      endDate: "Aug 2026",
      phaseId: "year-3",
      semesterId: "sem-5",
      ...
      status: "completed",
      importance: "major",
      skills: ["Hackathon Leadership", "Large-Scale Event Logistics", "Problem Statement Curation", "Team Management", "Public Speaking"],
      organization: "United Institute of Technology (UIT), Prayagraj",
      role: "Lead Student Organizer & Coordinator",
      location: "Prayagraj, Uttar Pradesh, India",
      whatHappened: "Managed 76 participating teams, room-wise evaluations, technical Q&A sessions, and judging workflows.",
      whyItMattered: "Core leadership responsibility driving student innovation and national hackathon readiness at the college level.",
    ...
    {
      id: "sem-5-hackerrank-uit-co-lead",
      title: "Co-Lead & Core Team Member at HackerRank UIT Student Club",
      shortDescription: "Organized inaugural coding contest for 140+ 2nd-year CSE students; co-hosted Orientation 2026.",
      fullDescription: "Served as Co-Lead and Core Team Member for HackerRank UIT Student Club. Successfully organized the HackerRank Orientation & Introduction Session 2026 and spearheaded the Departmental Coding Competition for 140+ students of CSE (Data Science) and CSE (AI & ML).",
      startDate: "Jul 2026",
      endDate: "Present",
      phaseId: "year-3",
      semesterId: "sem-5",
      ...
      status: "completed",
      importance: "major",
      skills: ["Competitive Programming", "DSA Problem Setting", "Platform Administration", "Community Leadership"],
      organization: "HackerRank UIT Student Club",
      role: "Co-Lead & Core Team Member",
      location: "Prayagraj, Uttar Pradesh, India",
      whatHappened: "Curated problem sets on HackerRank and managed lab operations for 140+ student coders.",
      whyItMattered: "Directly fostered competitive programming and problem-solving culture for junior engineering batches.",
      whatILearned: "Contest problem creation, test case validation, and community coordination.",
      impact: "Generated 250,000+ impressions on LinkedIn, showcasing college coding excellence.",
      evidence: {
        images: [],
        links: [],
        github: null,
    ...
    {
      id: "sem-5-cybersuraksha-iit-kanpur",
      title: "CyberSuraksha Scholar — C3iHub, IIT Kanpur & realme India",
      shortDescription: "Shortlisted for advanced CyberSuraksha Cybersecurity training program by C3iHub IIT Kanpur.",
      fullDescription: "Shortlisted for the national CyberSuraksha Cybersecurity Training Program, organized by C3iHub at Indian Institute of Technology Kanpur (IIT-K) and realme India via AKTU. Gaining advanced training in virtual security labs, digital forensics, threat mitigation, and online safety.",
      startDate: "Aug 2026",
      endDate: "Present",
      phaseId: "year-3",
      semesterId: "sem-5",
      ...
      status: "current",
      importance: "major",
      skills: ["Cybersecurity", "C3iHub Virtual Labs", "Threat Intelligence", "Incident Response", "Identity Protection"],
      organization: "C3iHub, IIT Kanpur & realme India",
      role: "Cybersecurity Trainee",
      location: "IIT Kanpur / Remote, India",
      whatHappened: "Selected for prestigious institutional training with IIT Kanpur cyber defense center.",
      whyItMattered: "Direct access to premier research center expertise in cyber forensics and threat defense.",
      whatILearned: "Ransomware analysis, financial fraud detection, OSINT virtual labs, and cyber hygiene protocols.",
      impact: "Deepened applied security competence complementing UP Police APCSIP fellowship.",
      evidence: {
        images: [],
        links: [],
        github: null,
    ...
    {
      id: "sem-5-eduwiki-hub-mentorship",
      title: "EduWiki Hub Global Mentorship Program — Cohort 2 Mentee",
      shortDescription: "Selected for 6-month international mentorship program under Wikipedia & Education User Group.",
      fullDescription: "Selected as one of the few mentees representing India in the 2nd Cohort of the EduWiki Hub Mentorship Program, officially organized under the Wikipedia & Education User Group. Receiving structured global mentorship on Wikimedia education projects, policy advocacy, and community leadership.",
      startDate: "Jul 2026",
      endDate: "Present",
      phaseId: "year-3",
      semesterId: "sem-5",
      ...
      status: "current",
      importance: "major",
      skills: ["Wikimedia Ecosystem", "Global Mentorship", "Open Knowledge Governance", "Community Policy"],
      organization: "Wikipedia & Education User Group / Wikimedia Foundation",
      role: "Global Mentee (India Representative)",
      location: "Global Wikimedia Community",
      whatHappened: "Profile officially featured on Meta-Wiki EduWiki Hub cohort page.",
      whyItMattered: "Elevates open-source profile from technical contributor to international open knowledge leader.",
      whatILearned: "Cross-cultural open knowledge frameworks, education-focused Wikimedia tools, and policy governance.",
      impact: "Representing Indian student developer community in global Wikimedia education forums.",
      evidence: {
        images: [],
        links: ["https://meta.wikimedia.org/wiki/Wikipedia_%26_Education_User_Group/EduWiki_Hub"],
        github: null,
        certificate: null,
        linkedin: "https://www.linkedin.com/in/gkm563/"
      }
    ...
    {
      id: "sem-5-build-with-gemma-kaggle",
      title: "Core Organizing Team — [AI Prayagraj] Build with Gemma: Kaggle",
      shortDescription: "Co-organized Google AI event covering Gemma Edge fine-tuning and Kaggle workflows for 100+ students.",
      fullDescription: "Served on the Core Organizing Team for [AI Prayagraj] Build with Gemma: Kaggle, organized in collaboration with GDG Prayagraj and TFUG. Facilitated sessions by Google Developer Experts on running fine-tuned Gemma models on edge devices and Kaggle workflows.",
      startDate: "Aug 2026",
      endDate: "Aug 2026",
      phaseId: "year-3",
      semesterId: "sem-5",
      ...
      status: "completed",
      importance: "normal",
      skills: ["Google AI", "Gemma LLMs", "Edge AI", "Kaggle", "Developer Community"],
      organization: "Google Developer Groups (GDG) Prayagraj & TFUG",
      role: "Core Organizing Team Member",
      location: "Prayagraj, Uttar Pradesh, India",
      whatHappened: "Co-organized hands-on workshop introducing first-year students to Gemma open models and Kaggle.",
      whyItMattered: "Promoted frontier open-weights AI adoption and hands-on LLM deployment in Prayagraj.",
      whatILearned: "Edge AI quantization, Gemma architecture, and developer workshop curation.",
      impact: "Mentored 100+ attendees on AI engineering career pathways.",
      evidence: {
        images: [],
        links: [],
        github: null,
    ...
    {
      id: "sem-5-qiskit-global-summer-school",
      title: "IBM Quantum — Qiskit Global Summer School 2026",
      shortDescription: "Participated in IBM Quantum's flagship 2-week global summer school exploring quantum algorithms and Qiskit SDK.",
      fullDescription: "Selected for IBM Quantum's 2-week intensive Qiskit Global Summer School 2026 ('A Decade on the Cloud'). Completed lectures, quantum circuit simulations, and hands-on algorithm labs on real IBM quantum hardware backends.",
      startDate: "Jul 2026",
      endDate: "Aug 2026",
      phaseId: "year-3",
      semesterId: "sem-5",
      ...
      status: "completed",
      importance: "normal",
      skills: ["Quantum Computing", "Qiskit SDK", "Quantum Circuits", "Quantum Algorithms", "IBM Cloud"],
      organization: "IBM Quantum / IBM Cloud",
      role: "Quantum Computing Scholar",
      location: "Global Online",
      whatHappened: "Completed rigorous quantum physics and quantum computing algorithm modules on IBM Quantum backends.",
      whyItMattered: "Expanded algorithmic thinking beyond classical architectures into quantum circuits and Qiskit.",
      whatILearned: "Qiskit Python SDK, statevectors, Bloch sphere representation, and quantum error mitigation.",
      impact: "Equipped with foundational quantum algorithms and quantum cloud workflows.",
      evidence: {
        images: [],
        links: [],
        github: null,
    ...
    {
      id: "sem-5-open-source-connect-lead",
      title: "Campus Lead for Open Source Connect India 2026 (OSCI'26)",
      shortDescription: "Selected as Campus Lead to mentor students in open source, Git workflows, and developer community building.",
      fullDescription: "Appointed as Campus Lead for Open Source Connect India 2026 (OSCI'26). Fostering an inclusive FOSS culture on campus, mentoring student developers in Git/GitHub contribution pipelines, and connecting campus talent with national open-source initiatives.",
      startDate: "Aug 2026",
      endDate: "Present",
      phaseId: "year-3",
      semesterId: "sem-5",
      ...
      status: "current",
      importance: "normal",
      skills: ["Open Source Advocacy", "Git / GitHub", "Student Mentorship", "FOSS Communities"],
      organization: "Open Source Connect India (OSCI'26)",
      role: "Campus Lead",
      location: "Prayagraj, Uttar Pradesh, India",
      whatHappened: "Appointed to lead campus chapter and drive collaborative open-source sprints.",
      whyItMattered: "Creates a sustainable pathway for Tier-2/3 engineering students to enter global open-source ecosystems.",
      whatILearned: "Community onboarding workflows, beginner-friendly issue triage, and mentoring methodologies.",
      impact: "Onboarding dozens of first-time open-source contributors.",
      evidence: {
        images: [],
        links: [],
        github: null,
