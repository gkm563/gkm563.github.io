...
export const JOURNEY_DATA = {
  ...
  milestones: [
    ...
    {
      id: "sem-5-hackerrank-core-member",
      title: "Core Member at HackerRank Student Chapter UIT",
      shortDescription: "Organized online coding contests and competitive programming drives for engineering students.",
      fullDescription: "Collaborated with technical leads to curate coding problem sets, review student submissions, and manage scoreboard ranking engines. Conducted DSA mentorship sessions.",
      startDate: "Jul 2026",
      endDate: "Present",
      phaseId: "year-3",
      semesterId: "sem-5",
      ...
      role: "Core Team Member",
      location: "Prayagraj, India",
      whatHappened: "Collaborated to organize mock tests and coding contests to prepare students for technical interviews.",
