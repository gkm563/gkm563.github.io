...
═══════════════════════════════════════ -->
<p align="center">
  <a href="https://gkm563.github.io/"><img src="https://img.shields.io/badge/🌐%20Official%20Portfolio-gkm563.github.io-00F7FF?style=for-the-badge&logo=google-chrome&logoColor=black" alt="Portfolio Website" /></a>
  ...
  <a href="https://gkm563.github.io/open-source-contributions.html"><img src="https://img.shields.io/badge/Open%20Source-Wikimedia%20Core%20(15%2B%20Patches)-00C853?style=for-the-badge&logo=wikipedia&logoColor=white" alt="Wikimedia Core Contributor" /></a>
...
## 📌 Executive Knowledge Snippet & SEO Search Index
...
| **Best Topper in United Institute of Technology** | **Rank 5 College-wide Topper** across AKTU 1st Year Examinations (Highest CGPA) | [👉 Topper Profile](https://gkm563.github.io/#about) |
| **LPAI Internship Program 2026 Shortlist** | Land Ports Authority of India (LPAI) — Border Infrastructure & Smart Data Logistics | [👉 LPAI Milestone](https://gkm563.github.io/btech-journey.html) |
| **SIH 2026 Lead Organizer (500+ Participants)** | Head Student Lead for Smart India Hackathon 2026 Internal Hackathon at UIT (76 Teams) | [👉 Leadership Details](https://gkm563.github.io/#leadership) |
| **Best Cyber Security Expert in Prayagraj** | Digital Forensics, OSINT, CDR/IPDR Analysis, Cyber Security Researcher | [👉 UP Police Report](https://gkm563.github.io/up-police-internship.html) |
| **Cyber Crime Consultant Prayagraj** | APCSIP-2026 Fellow with UP Police & Amroha Police (Best Content Creator Awardee) | [👉 Case Studies](https://gkm563.github.io/up-police-internship.html) |
| **C3iHub IIT Kanpur CyberSuraksha Scholar** | Selected for national cybersecurity virtual labs by IIT Kanpur & realme India via AKTU | [👉 Cyber Credentials](https://gkm563.github.io/#achievements) |
| **GeeksforGeeks UIT Vice President** | VP & Technical Team Lead for GFG Student Chapter at UIT Prayagraj (600+ attendees) | [👉 Leadership Details](https://gkm563.github.io/#leadership) |
| **Best Open Source Contributor in UIT** | 30+ contributions, 15+ merged production patches into **Wikimedia MediaWiki Core** | [👉 Wikimedia Report](https://gkm563.github.io/open-source-contributions.html) |
...
🎓 **Consistent Academic Topper (UIT / UGI / AKTU):** Gautam holds an exemplary academic record. In his B.Tech CSE (Data Science) program at **United Institute of Technology (UIT), Prayagraj (United Group of Institutions)**, he achieved **1st Rank across the CSE (Data Science) branch (SGPA 8.5)** and **5th Rank across the entire college** in AKTU examinations, felicitated by *Dainik Jagran* & the UP Board Secretary.

⚡ **Full-Stack AI & Secure Web Architect:** A sharp, agile technology innovator, Gautam engineers production-grade web systems, custom AI agent workflows, and scalable REST APIs with robust security standards.

🚀 **Founder Acceleration & Community Leadership:** Serving as **Vice President of GeeksforGeeks (GFG) Student Chapter UIT**, **Co-Lead of HackerRank UIT**, **Campus Lead of Open Source Connect India (OSCI'26)**, and **Head Lead Organizer for Smart India Hackathon (SIH 2026)**, Gautam actively mentors 500+ student developers while co-founding real-world startups like [**PrayagrajRooms**](https://prayagrajrooms.in).
...
```
⚡ Full-Stack Web Development  :: React 18, Next.js, Node.js, Express, TypeScript, Tailwind CSS, GSAP, REST APIs
🤖 AI & Data Science          :: Python, PyTorch, FAISS, FastEmbed, Agentic AI, QGIS, OpenCV, Pandas, NumPy
🔐 Cyber Security & Forensics  :: OSINT Reconnaissance, CDR/IPDR Log Analysis, Mobile Forensics, SOC Operations, C3iHub Labs
🛠️ Open Source & DevOps       :: Git, GitHub, GitLab, Gerrit Code Review, Phabricator, MediaWiki Core, Docker, Linux
🗄️ Database Architecture      :: PostgreSQL, MySQL, SQLite Edge, MongoDB, Firebase Firestore, Redis
```

---

## 🏆 Verified Honors, Fellowships & Leadership
...
* 🌐 **EduWiki Hub Global Mentee (Cohort 2)** – Selected as India representative under the **Wikipedia & Education User Group**.
* 🥇 **Best Content Creator Award** – Awarded directly by **DSP Anjali Kataria Ma'am** (15-Day UP Police Cyber Security Internship APCSIP-2026).
...
* 🏆 **1st Rank CSE (Data Science) Branch Topper (SGPA 8.5)** – Secured 1st Position in CSE (DS) at United Institute of Technology (UIT), Prayagraj.
* 🏆 **Rank 5 College-wide Topper (AKTU)** – Secured Top 5 position across the entire college in 1st Year AKTU examinations.
* 🛠️ **15+ Merged Production Open Source Patches** – Merged into Wikimedia Core, MinervaNeue, GrowthExperiments, Pywikibot, and Wikifunctions (Featured in IIIT Hyderabad Impact Report).
* 🥇 **1st Place Winner — 1-Week Open Source Marathon** – Organized by **WikiClub Tech UIT**.
...
* 🏅 **Felicitation by Dainik Jagran & UP Board Secretary** – District academic excellence recognition.
...
## 🛠️ Open Source & Production Merges (Wikimedia Core)

* 🛠️ **15+ Merged Production Patches** across MediaWiki Core, MinervaNeue, GrowthExperiments, Pywikibot, and Wikifunctions via Gerrit.
* 🔄 **10+ Active Contributions** undergoing Gerrit code review.
* 📰 **Featured in Technical Impact Report (Jan–Jun 2026):** Published by Open Knowledge Initiatives (OKI) at IIIT Hyderabad.
* 🥇 **1st Rank Winner:** 1-Week Open Source Contribution Marathon by WikiClub Tech UIT.
...
<p align="center">
  ...
  <img src="https://github-profile-summary-cards.vercel.app/api/cards/most-commit-language?username=gkm563&theme=tokyonight" width="49%" alt="Most Commit Language" />
</p>

<p align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=gkm563&theme=tokyo-night&hide_border=true&radius=16" width="95%" alt="Activity Graph" />
</p>
